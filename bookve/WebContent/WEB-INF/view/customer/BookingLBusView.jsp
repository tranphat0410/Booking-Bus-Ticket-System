...
<head>
    ...
    <link rel="stylesheet" href="style/css/bookinglimosine.css">
...
<body>
    ...
    <article>
        <section style="width: 85%" class="row mx-auto">
                    ...
                    <div class="col-lg-6 mx-auto text-center">
                        ...
                        <div class="col-lg-12 mt-1 mb-2">
                            <marquee behavior="alternate" direction="">
                                <a style="color: blue; font-size: 40px;"><i class="fas fa-bus-alt"></i> Limousine <i class="fas fa-bus-alt"></i></a>
                            </marquee>
                        </div>
                    </div>
                </div>
            ...
            <div id="myDIV2" style="width: 400px;" class="mb-4 mt-2 ml-3">
                ...
                <div style="border-top-left-radius: 80px;border-top-right-radius: 80px" class="card border">
                    <div style="color:white;background-color: blue;border-top-left-radius: 80px;border-top-right-radius: 80px"
                        class="card-header text-center">Type Bus: Limousine</div>
                    <div style="background-color: #ADD8E6;" class="card-body">
                        <h5 class="card-title text-center">Number: </h5>
                        <div class="row">
                            <div style="margin-left:5%;" class="driver">
                                <i style="color:#006400;font-size:x-large; margin-left: 5px;" class="fas fa-couch"></i>
                                <p>Driver</p>
                            </div>
                        ...
                        <!--Front row------------------------------------------------------------------->
                        <div style="font-size: larger;border-top-style: dotted;" class="row text-center mt-3">
                            ...
                            <div class="chair ml-3">
                                <%
									...
									<c:forEach items="${travels}" var="travel">
										...
										class="fas fa-couch" style="font-size: larger;"></i>
