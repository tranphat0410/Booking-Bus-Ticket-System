...
<link rel="stylesheet" href="style/css/bookingnormal.css">
<link rel="stylesheet"
	href="style/fontawesome-free-5.13.1-web/css/all.min.css">
</head>
...
<body>
			...
			<div style="width: 85%" class="row mx-auto">
				...
				<div class="col-lg-8 mt-3 mb-3">
						...
						<div class="col-lg-6 mx-auto text-center">
							...
							<div class="col-lg-12 mt-1 mb-2">
								<marquee behavior="alternate" direction="">
									<a style="color: green; font-size: 40px;"><i
										class="fas fa-bus-alt"></i> Normal <i class="fas fa-bus-alt"></i></a>
								</marquee>
							</div>
						</div>
					</div>
					...
					<div class="row mt-2">
						...
						<div class="col-lg-6">
							<div class="find"
								style="background: linear-gradient(to right, green, yellow); text-align: center; height: 40px; padding: auto;">
								<a class="pick text-white"> Please choose one or more seat
									in this bus <i class="fas fa-angle-double-right"></i> <i
									class="fas fa-angle-double-right"></i> <i
					...
					<div class="main mt-3">
						<div class="box">
							<c:forEach items="${travels}" var="travel">
								...
								<p>
									Ngày khởi hành:
									<fmt:formatDate type="date" value="${travel.getTime()}" />
								</p>
								<c:choose>
									<c:when test="${travel.getTypeTravel() == 'Round'}">
										<p>
											Ngày về:
											<fmt:formatDate type="date" value="${travel.getTimeout()}" />
										</p>
									</c:when>
								</c:choose>
								...
								<p>
									Xe Buýt: ${travel.getNumberBus()}								</p>
								Front: <fmt:formatNumber type="number" groupingUsed="true" value="${travel.getPriceFront()}" /> VND <br>
                                    Middle: <fmt:formatNumber type="number" groupingUsed="true" value="${travel.getPriceMiddle()}" /> VND <br>
                                    Last: <fmt:formatNumber type="number" groupingUsed="true" value="${travel.getPriceLast()}" /> VND
				...
				<!--------------------Bus Normal------------------------------------------------------------->
				<div id="myDIV1" style="display: block; width: 400px;"
					...
					<div
						style="border-top-left-radius: 80px; border-top-right-radius: 80px"
						class="card border">
						<div
							style="color: white; background-color: green; border-top-left-radius: 80px; border-top-right-radius: 80px"
							class="card-header text-center">Type Bus: Normal</div>
						<div style="background-color: #87f0a1;" class="card-body">
							<h5 class="card-title text-center">Number:</h5>
							<div class="row">
								<div style="margin-left: 5%;" class="driver">
									<i
										style="color: #006400; font-size: x-large; margin-left: 5px;"
										class="fas fa-couch"></i>
									<p>Driver</p>
								</div>
								<div style="margin-left: 70%;" class="exit">
									<i style="color: red; font-size: x-large"
										class="fas fa-door-open"></i>
									<p>EXIT</p>
								</div>
							</div>
							<div
								style="border-radius: 5px; background-color: Gainsboro; border-style: double; width: 100%; text-align: center;"
							...
							<!------------------Front row------------------------------------------------------>
							<div style="font-size: larger; border-top-style: dotted;"
								class="row text-center mt-3">
								<div class="chair ml-3 mt-3">
									<%
											int f;
										for (int i = 1; i <= 9; i += 4) {
											f = 0;
										...
										<c:choose>
											<c:when test="${checked == check}">
												<%
														f = 1;
													%>
												<i class="fas fa-couch" style="color: brown;"></i>
							...
							<!-----------------------------Middle row------------------------------------------>
							<div style="font-size: larger" class="row text-center mt-3">
								<div class="chair ml-3">
									<%
										for (int i = 1; i <= 9; i += 4) {
											f = 0;
										%>
									...
									%>
									<c:forEach items="${travels}" var="travel">
									<a href="#" onclick="getvalue(this, ${travel.getPriceMiddle()})"
										id="f<%=String.valueOf(i)%>" class="btncolor"><i
										class="fas fa-couch"></i>
										<p style="font-size: small;">
								...
								<div class="typerow mx-auto">
									<p>Center row</p>
								</div>
								<!-- -------------------------------------------------- -->
								<!-- ----------------------C3-------------------------- -->
								<!-- -------------------------------------------------- -->
								<div class="chair mr-3">
									<%
										for (int i = 3; i <= 7; i += 4) {
											f = 0;
										%>
							...
							<div style="font-size: larger" class="row text-center mt-3">
								<div class="chair ml-3">
									...
									%>
									<c:forEach items="${travels}" var="travel">
									<a href="#" onclick="getvalue(this, ${travel.getPriceLast()})"
										id="f<%=String.valueOf(i)%>" class="btncolor"><i
										class="fas fa-couch"></i>
										<p style="font-size: small;">
							...
							<!--------------------Hàng cuối----------------------------------------------------->
							<div style="font-size: larger" class="row text-center">
								<div class="chair ml-3">
									<%
										for (int i = 13; i <= 13; i += 4) {
											f = 0;
	...
	<footer class="page-footer"
		...
		<div class="mau"
			style="background: linear-gradient(to right, rgba(4, 77, 32), yellow)">
			<div class="container">
				<div class="row-py-4 d-flex align-item-center">
					<div class="col-md-12 text-center p-3">
						<a href=" #" class="fab fa-facebook-square text-white mr-5"> </a>
						<a href="#" class="fab fa-instagram text-white mr-5"> </a> <a
							href="#" class="fab fa-youtube text-white mr-5"> </a> <a href="#"
							class="fab fa-twitter-square text-white mr-5"></a> <a href="#"
							class="far fa-paper-plane text-white mr-5"></a>
					</div>
				</div>
			</div>
		</div>
		<div class="container text-center text-md-left mt-5">
			<div class="row">
				<div class="col-md-3 mx-auto mb-4">
					<h6 class="text-uppercase font-weight-bold text-white">Trang
						Chủ</h6>
				...
				<div class="col-md-3 mx-auto mb-4">
					<h6 class="text-uppercase font-weight-bold text-white">Tuyến
						Bus Phổ Phiến</h6>
					<hr class="bg-success mb-4 mt-0 d-inline-block mx-auto"
						style="width: 125px; height: 2px">
					<a href="#" style="color: white;">
				...
				<div class="col-md-3 mx-auto mb-4 text-white">
					<h6 class="text-uppercase font-weight-bold text-white">Liên Hệ
						Với Chúng Tôi</h6>
					<hr class="bg-success mb-4 mt-0 d-inline-block mx-auto"
						style="width: 125px; height: 2px">
					<p>
						<i class="fa fa-envelope " aria-hidden="true"></i>
						letheduc0812@gmail.com
					</p>
					<p>
						<i class="fa fa-map-marker " aria-hidden="true"></i> Hoang Hoa
						Tham Street, Ho Chi Minh City, Viet Nam
					</p>
					<p>
						<i class="fa fa-phone " aria-hidden="true"></i> 1111-2222-3333
					</p>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
        function getvalue(element, money)
        {
        	...
        	if (document.getElementById("seat").value == "" && document.getElementById("seat2").value == "" && document.getElementById("seat3").value == "") {
                ...
                if (document.getElementById("seat").value.indexOf(ghe) == -1 && document.getElementById("seat2").value.indexOf(ghe) == -1 && document.getElementById("seat3").value.indexOf(ghe) == -1) {
                    document.getElementById("seat").value += "," + ghe;
                    document.getElementById("seat2").value +=  ghe;
                    document.getElementById("seat3").value += "," + ghe;
